...
//		}
		...
		public void MakeBlock_003_Preset_Check() throws InterruptedException {
		    ...
		    Thread.sleep(1000);
		    Common.Assert_ExistByXpath("/html/body/div[10]/div/div/div[2]/div[1]/div[1]/img"); //썸네일

		    Thread.sleep(1000);
		    Assert.assertEquals(driver.findElement(By.xpath("/html/body/div[10]/div/div/div[2]/div[1]/p[2]")).getText(), "깔끔한 화이트톤의 약 300인 좌석 컨퍼런스 홀입니다."); //설명
		    Thread.sleep(1000);
		    Common.Assert_ExistByXpath("/html/body/div[10]/div/div/div[2]/div[2]/div[2]/div/input"); //블록 이름 입력란
		}
		
		@Test
		public void MakeBlock_004_Preset_CheckBtn() throws InterruptedException {
			
		    Assert.assertFalse(driver.findElement(By.xpath("/html/body/div[10]/div/div/div[2]/div[2]/button")).isEnabled()); //버튼 비활성화 체크
		}
...
//			
			Common.InputTextXpath("/html/body/div[10]/div/div/div[2]/div[2]/div[2]/div/input", "라일리첫블록"); //블록 제목 라일리 입력
			Common.Enter("/html/body/div[10]/div/div/div[2]/div[2]/div[2]/div/input"); //엔터
		...
		public void MakeBlock_006_Preset_Make() throws InterruptedException {
			...
			Common.clickByXpath("/html/body/div[10]/div/div/div[2]/div[2]/button"); //블록 만들기 버튼 클릭
			Thread.sleep(5000);
