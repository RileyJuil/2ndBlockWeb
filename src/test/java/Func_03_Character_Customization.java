...
//			Common.clickByXpath("/html/body/div[1]/div[1]/div[2]/div[1]/div[1]/div[2]/div/img"); //마이메뉴
		...
		public void Character_002_Skin() throws InterruptedException {
			...
			Thread.sleep(1000);
			Common.clickByXpath("/html/body/div[5]/div/div/div[2]/div[2]/div[2]/ul/li[3]"); //스킨 선택
		...
		public void Character_003_Hair() throws InterruptedException {
			...
			Thread.sleep(1000);
			Common.clickByXpath("/html/body/div[5]/div/div/div[2]/div[2]/div[2]/ul/li[12]"); //헤어 선택
			Common.clickByXpath("/html/body/div[5]/div/div/div[2]/div[2]/div[3]/ul/li[4]/div"); //헤어 색상 선택
	  }
		...
		public void Character_004_Top() throws InterruptedException {
			...
			Thread.sleep(2000);
			Common.clickByXpath("/html/body/div[5]/div/div/div[2]/div[2]/div[1]/ul/li[3]"); //상의 탭 선택
			Thread.sleep(1000);
			Common.clickByXpath("/html/body/div[5]/div/div/div[2]/div[2]/div[2]/ul/li[6]"); //상의 선택
			Common.clickByXpath("/html/body/div[5]/div/div/div[2]/div[2]/div[3]/ul/li[3]/div"); //상의 색상 선택
	  }
		...
		public void Character_005_Bottom() throws InterruptedException {
			...
			Common.clickByXpath("/html/body/div[5]/div/div/div[2]/div[2]/div[3]/ul/li[3]/div"); //하의 색상 선택
	  }
		
		@Test
		public void Character_006_Bag() throws InterruptedException {
			
			Common.clickByXpath_Hidden("/html/body/div[5]/div/div/div[2]/div[2]/div[1]/div[4]/button");
			Common.clickByXpath_Hidden("/html/body/div[5]/div/div/div[2]/div[2]/div[1]/div[4]/button");

			Thread.sleep(1000);
			Common.clickByText("가방");
			Thread.sleep(1000);
			Common.clickByXpath("/html/body/div[5]/div/div/div[2]/div[2]/div[2]/ul/li[6]"); //가방 선택
	  }
		...
		public void Character_007_Cap() throws InterruptedException {
			...
			Thread.sleep(1000);
			Common.clickByXpath("/html/body/div[5]/div/div/div[2]/div[2]/div[2]/ul/li[2]"); //모자 선택
	  }
		...
		public void Character_008_Shose() throws InterruptedException {
			...
			Thread.sleep(1000);
			Common.clickByXpath("/html/body/div[5]/div/div/div[2]/div[2]/div[2]/ul/li[6]"); //신발 선택
	  }
		...
		public void Character_009_Socks() throws InterruptedException {
			...
			Thread.sleep(1000);
			Common.clickByXpath("/html/body/div[5]/div/div/div[2]/div[2]/div[2]/ul/li[7]"); //양말 선택
	  }
		...
		public void Character_010_Accessories() throws InterruptedException {
			...
			Thread.sleep(1000);
			Common.clickByXpath("/html/body/div[5]/div/div/div[2]/div[2]/div[2]/ul/li[1]"); //악세사리 1 선택
			Thread.sleep(1000);
			Common.clickByXpath("/html/body/div[5]/div/div/div[2]/div[2]/div[2]/ul/li[7]"); //악세사리 7 선택
			Thread.sleep(1000);
			Common.clickByXpath("/html/body/div[5]/div/div/div[2]/div[2]/div[2]/ul/li[8]"); //악세사리 8 선택
			Thread.sleep(1000);
	  }
