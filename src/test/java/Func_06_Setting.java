...
//		}
		...
		public void Setting_002_MediaSetting_OnOffMike() throws InterruptedException {
			Thread.sleep(2000);
			Common.clickByXpath("/html/body/div[6]/div/div/div[3]/div/div[1]/div[1]/div[1]/div/div[1]/img"); //마이크 on
			Thread.sleep(2000);
			Common.clickByXpath("/html/body/div[6]/div/div/div[3]/div/div[1]/div[1]/div[1]/div/div[1]/img"); //마이크 off
		}
		
		@Test
		public void Setting_003_MediaSetting_OnOffCamera() throws InterruptedException {
			Thread.sleep(2000);
			Common.clickByXpath("/html/body/div[6]/div/div/div[3]/div/div[1]/div[1]/div[1]/div/div[2]/img"); //카메라 on
			Thread.sleep(2000);
			Common.clickByXpath("/html/body/div[6]/div/div/div[3]/div/div[1]/div[1]/div[1]/div/div[2]/img"); //카메라 off
		}
	
		@Test
		public void Setting_004_MediaSetting_Filter() throws InterruptedException {
			Thread.sleep(2000);
			Common.clickByXpath("/html/body/div[6]/div/div/div[3]/div/div[1]/div[2]/div[2]/div[2]"); //필터씌우기 첫번째 선택
			Thread.sleep(4000);
		}
	
		@Test
		public void Setting_005_MediaSetting_BG() throws InterruptedException {
			Common.clickByXpath("/html/body/div[6]/div/div/div[3]/div/div[1]/div[2]/div[4]/div[2]"); //배경 필터 첫번째 선택
			Thread.sleep(4000);
	  }
		...
		public void Setting_008_ProfileSetting_Nick_Guide() throws InterruptedException {
			...
			Common.Assert_ExistByXpath("/html/body/div[6]/div/div/div[3]/div/div[1]/div[1]/div[2]/div[3]/div"); //닉네임 변경 가이드 문구 확인
			Thread.sleep(1000);
		}
		...
		public void Setting_009_ProfileSetting_Nick_Xbtn() throws InterruptedException {
			Common.clickByXpath("/html/body/div[6]/div/div/div[3]/div/div[1]/div[1]/div[2]/div[2]/img"); //X버튼 클릭
		...
		public void Setting_010_ProfileSetting_Nick_1Text20() throws InterruptedException {
			...
			driver.findElement(By.xpath("/html/body/div[6]/div/div/div[3]/div/div[1]/div[1]/div[2]/div[2]/input")).sendKeys("페"); //닉네임 1자 입력
		    Common.Assert_ExistByText("닉네임은 2~20자 사이로 입력해주세요."); //닉네임 에러 메시지 확인
		    Thread.sleep(1000);
		    Common.clickByXpath("/html/body/div[6]/div/div/div[3]/div/div[1]/div[1]/div[2]/div[2]/img"); //입력한 닉네임 X버튼으로 삭제
		    Thread.sleep(1000);
		    
		    driver.findElement(By.xpath("/html/body/div[6]/div/div/div[3]/div/div[1]/div[1]/div[2]/div[2]/input")).sendKeys("일이삼사오륙칠팔구십일이삼사오륙칠팔구십일"); //닉네임 21자 입력
		    Thread.sleep(1000);
		...
		public void Setting_011_ProfileSetting_Nick_NotText() throws InterruptedException {
			...
			driver.findElement(By.xpath("/html/body/div[6]/div/div/div[3]/div/div[1]/div[1]/div[2]/div[2]/input")).sendKeys("ㄱㄴ!"); //닉네임 특수문자 입력
			Thread.sleep(1000);
		...
		public void Setting_012_ProfileSetting_Nick_Duplicate() throws InterruptedException {
			...
			Common.clickByXpath("/html/body/div[6]/div/div/div[3]/div/div[1]/div[1]/div[2]/div[2]/img"); //입력한 닉네임 X버튼으로 삭제
			Thread.sleep(1000);
			driver.findElement(By.xpath("/html/body/div[6]/div/div/div[3]/div/div[1]/div[1]/div[2]/div[2]/input")).sendKeys("Riley"); //닉네임 중복 입력
			Thread.sleep(1000);
		...
		public void Setting_014_ProfileSetting_Nick_Normal() throws InterruptedException {
			...
			//가입 후 재가입 시 닉네임도 계속 중복되어 시간을 붙였으나 닉네임도 사용 가능하도록 풀어줘서 그냥 원래대로 함
//			Date date = new Date();
//			System.out.println(date.toString());
//			SimpleDateFormat sdf = new SimpleDateFormat("ddMMyyyyhhmmss");
//			String formattedDate = sdf.format(date);
//		    driver.findElement(By.xpath("/html/body/div[7]/div/div/div[3]/div/div[1]/div[1]/div[2]/div[2]/input")).sendKeys("페이스북(라일리)"+ formattedDate); //닉네임 입력
//		    
		    Common.InputTextXpath("/html/body/div[6]/div/div/div[3]/div/div[1]/div[1]/div[2]/div[2]/input", "페이스북(라일리)new");
		  }
		...
		public void Setting_015_ProfileSetting_ADagree() throws InterruptedException {
			...
			Thread.sleep(1000);
			Common.clickByXpath("/html/body/div[6]/div/div/div[3]/div/div[1]/div[4]/label"); //광고 동의 OFF
